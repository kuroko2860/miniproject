...
func (x *ObjectRequest) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
func (x *ObjectRequest) GetColor() string {
	if x != nil {
		return x.Color
	}
	return ""
...
func (x *ObjectRequest) GetLat() float32 {
	if x != nil {
		return x.Lat
	}
	return 0
...
func (x *ObjectRequest) GetLng() float32 {
	if x != nil {
		return x.Lng
	}
	return 0
...
func (x *ObjectRequest) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
func (x *ObjectRequest) GetTimestamp() int64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
func (x *ObjectResponse) GetAck() string {
	if x != nil {
		return x.Ack
	}
	return ""
...
var file_object_proto_rawDesc = []byte{
	...
	0x6f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x22, 0xa3, 0x01, 0x0a, 0x0d, 0x4f, 0x62, 0x6a, 0x65, 0x63,
	...
	0x6f, 0x72, 0x12, 0x10, 0x0a, 0x03, 0x6c, 0x61, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x02, 0x52,
	0x03, 0x6c, 0x61, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x6c, 0x6e, 0x67, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x02, 0x52, 0x03, 0x6c, 0x6e, 0x67, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73,
	...
	0x03, 0x52, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x22, 0x22, 0x0a, 0x0e,
	...
	0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0x7d, 0x0a, 0x06, 0x4f,
	0x62, 0x6a, 0x65, 0x63, 0x74, 0x12, 0x3d, 0x0a, 0x0c, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4f,
	0x62, 0x6a, 0x65, 0x63, 0x74, 0x12, 0x15, 0x2e, 0x6f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x2e, 0x4f,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x34, 0x0a, 0x05, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x12, 0x14, 0x2e,
	0x6f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x2e, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x15, 0x2e, 0x6f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x2e, 0x48, 0x65, 0x6c,
	0x6c, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x1c, 0x5a, 0x1a, 0x6b, 0x75,
	0x72, 0x6f, 0x6b, 0x6f, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x67, 0x6f, 0x73, 0x65, 0x72, 0x76, 0x65,
...
var file_object_proto_goTypes = []interface{}{
	(*ObjectRequest)(nil),  // 0: object.ObjectRequest
	(*ObjectResponse)(nil), // 1: object.ObjectResponse
	(*HelloRequest)(nil),   // 2: object.HelloRequest
	(*HelloResponse)(nil),  // 3: object.HelloResponse
}
var file_object_proto_depIdxs = []int32{
	0, // 0: object.Object.CreateObject:input_type -> object.ObjectRequest
	2, // 1: object.Object.Hello:input_type -> object.HelloRequest
	1, // 2: object.Object.CreateObject:output_type -> object.ObjectResponse
	3, // 3: object.Object.Hello:output_type -> object.HelloResponse
